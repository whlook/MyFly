...
#define MPU6500_I2C_ADDR            ((uint8_t)0xD0)   // here is slave_address 
...
#define AK8963_I2C_ADDR             0x18//((uint8_t)0x0C) // 因为mpu左对齐，需要左移一位， 0x0c<<1 = 0x18
...
typedef struct MPU9250_float_data
{
